...
public class WeakeningIncense extends CustomRelic {
    ...
    public static final Logger logger = LogManager.getLogger(WeakeningIncense.class.getName());


    public WeakeningIncense() {
        super(ID, new Texture(ValiantMod.WEAKENING_INCENSE), RelicTier.COMMON, LandingSound.FLAT);
