...
public class CrownOfThorns extends CustomRelic {
    ...
    public static final Logger logger = LogManager.getLogger(CrownOfThorns.class.getName());

    public CrownOfThorns() {
        super(ID, new Texture(ValiantMod.CROWN_OF_THORNS), RelicTier.RARE, LandingSound.FLAT);
