...
public class HugeEgg extends CustomRelic {
    ...
    public static final Logger logger = LogManager.getLogger(HugeEgg.class.getName());


    public HugeEgg() {
        super(ID, new Texture(ValiantMod.HUGE_EGG), RelicTier.UNCOMMON, LandingSound.HEAVY);
