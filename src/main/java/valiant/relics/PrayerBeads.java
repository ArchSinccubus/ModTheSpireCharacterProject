...
public class PrayerBeads extends CustomRelic {
    ...
    public static final Logger logger = LogManager.getLogger(PrayerBeads.class.getName());


    public PrayerBeads() {
        super(ID, new Texture(ValiantMod.PRAYER_BEADS), RelicTier.UNCOMMON, LandingSound.FLAT);
